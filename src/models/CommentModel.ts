...
export interface CommentAttributes {
    ...
    createdAt?: string;
    updatedAt?: string;
    //OBS: Sempre que for utilizar uma chave estrangeira o atributo precisa ser do tipo number na estrutura.
    //como é o caso de post e user que fazem referência a chaves estrangeiras.
}
